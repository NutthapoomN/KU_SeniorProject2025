...
#include "m_Wtvfyp0vVmv7JmqwXgze2B.h"
...
static void cgxe_mdl_start(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
static void CheckPythonError(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key);
static void b_assignToPyDict(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void e_assignToPyDict(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void g_assignToPyDict(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *b_getPyDictVal(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance, PyObject *dict, char_T *key);
...
static void c_execPyScript(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S, int_T tid)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S, int_T tid)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S)
{
  InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *moduleInstance =
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B *)calloc(1, sizeof
    (InstanceStruct_Wtvfyp0vVmv7JmqwXgze2B));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Wtvfyp0vVmv7JmqwXgze2B);
  ssSetmdlInitializeConditions(S, mdlInitialize_Wtvfyp0vVmv7JmqwXgze2B);
  ssSetmdlUpdate(S, mdlUpdate_Wtvfyp0vVmv7JmqwXgze2B);
  ssSetmdlDerivatives(S, mdlDerivatives_Wtvfyp0vVmv7JmqwXgze2B);
  ssSetmdlTerminate(S, mdlTerminate_Wtvfyp0vVmv7JmqwXgze2B);
  ssSetmdlEnable(S, mdlEnable_Wtvfyp0vVmv7JmqwXgze2B);
  ssSetmdlDisable(S, mdlDisable_Wtvfyp0vVmv7JmqwXgze2B);
...
static void mdlProcessParameters_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S)
{
}

void method_dispatcher_Wtvfyp0vVmv7JmqwXgze2B(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Wtvfyp0vVmv7JmqwXgze2B(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Wtvfyp0vVmv7JmqwXgze2B(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Wtvfyp0vVmv7JmqwXgze2B.\n"
...
mxArray *cgxe_Wtvfyp0vVmv7JmqwXgze2B_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Wtvfyp0vVmv7JmqwXgze2B_fallback_info(void)
{
