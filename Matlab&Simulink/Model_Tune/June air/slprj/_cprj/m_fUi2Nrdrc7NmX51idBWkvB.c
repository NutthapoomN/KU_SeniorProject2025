...
static void cgxe_mdl_start(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
static void CheckPythonError(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance, PyObject *dict, char_T *key);
static void b_assignToPyDict(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *b_getPyDictVal(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static int32_T b_deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_fUi2Nrdrc7NmX51idBWkvB
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S, int_T tid)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S, int_T tid)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S)
{
  InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *moduleInstance =
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB *)calloc(1, sizeof
    (InstanceStruct_fUi2Nrdrc7NmX51idBWkvB));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_fUi2Nrdrc7NmX51idBWkvB);
  ssSetmdlInitializeConditions(S, mdlInitialize_fUi2Nrdrc7NmX51idBWkvB);
  ssSetmdlUpdate(S, mdlUpdate_fUi2Nrdrc7NmX51idBWkvB);
  ssSetmdlDerivatives(S, mdlDerivatives_fUi2Nrdrc7NmX51idBWkvB);
  ssSetmdlTerminate(S, mdlTerminate_fUi2Nrdrc7NmX51idBWkvB);
  ssSetmdlEnable(S, mdlEnable_fUi2Nrdrc7NmX51idBWkvB);
  ssSetmdlDisable(S, mdlDisable_fUi2Nrdrc7NmX51idBWkvB);
...
static void mdlProcessParameters_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S)
{
}

void method_dispatcher_fUi2Nrdrc7NmX51idBWkvB(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_fUi2Nrdrc7NmX51idBWkvB(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_fUi2Nrdrc7NmX51idBWkvB(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: fUi2Nrdrc7NmX51idBWkvB.\n"
...
mxArray *cgxe_fUi2Nrdrc7NmX51idBWkvB_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_fUi2Nrdrc7NmX51idBWkvB_fallback_info(void)
{
