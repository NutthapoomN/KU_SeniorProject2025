...
#include "m_N6r0Omof85N1Yr8uriaciC.h"
...
static void cgxe_mdl_start(InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
static void CheckPythonError(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key);
static void c_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void e_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void g_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void h_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void i_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void j_assignToPyDict(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *c_getPyDictVal(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance, PyObject *dict, char_T *key);
...
static void c_execPyScript(InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_N6r0Omof85N1Yr8uriaciC
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  b_execPyScript(moduleInstance,
                 ...
                 "AirStat >0 and Room_Temp<=23.9 and TES_set<TES_Temp :\n        return -1               #\"Charge\"\n    elif AirStat >0 and Room"
                 "_Temp<=23.9 and TES_set>=TES_Temp :\n        return 0#               \"off\"\n    else : return 404            #\"Error\"\n\n\ny"
...
/* CGXE Glue Code */
static void mdlOutputs_N6r0Omof85N1Yr8uriaciC(SimStruct *S, int_T tid)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_N6r0Omof85N1Yr8uriaciC(SimStruct *S)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_N6r0Omof85N1Yr8uriaciC(SimStruct *S, int_T tid)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_N6r0Omof85N1Yr8uriaciC(SimStruct *S)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_N6r0Omof85N1Yr8uriaciC(SimStruct *S)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_N6r0Omof85N1Yr8uriaciC(SimStruct *S)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_N6r0Omof85N1Yr8uriaciC(SimStruct *S)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_N6r0Omof85N1Yr8uriaciC(SimStruct *S)
{
  InstanceStruct_N6r0Omof85N1Yr8uriaciC *moduleInstance =
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC *)calloc(1, sizeof
    (InstanceStruct_N6r0Omof85N1Yr8uriaciC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_N6r0Omof85N1Yr8uriaciC);
  ssSetmdlInitializeConditions(S, mdlInitialize_N6r0Omof85N1Yr8uriaciC);
  ssSetmdlUpdate(S, mdlUpdate_N6r0Omof85N1Yr8uriaciC);
  ssSetmdlDerivatives(S, mdlDerivatives_N6r0Omof85N1Yr8uriaciC);
  ssSetmdlTerminate(S, mdlTerminate_N6r0Omof85N1Yr8uriaciC);
  ssSetmdlEnable(S, mdlEnable_N6r0Omof85N1Yr8uriaciC);
  ssSetmdlDisable(S, mdlDisable_N6r0Omof85N1Yr8uriaciC);
...
static void mdlProcessParameters_N6r0Omof85N1Yr8uriaciC(SimStruct *S)
{
}

void method_dispatcher_N6r0Omof85N1Yr8uriaciC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_N6r0Omof85N1Yr8uriaciC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_N6r0Omof85N1Yr8uriaciC(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: N6r0Omof85N1Yr8uriaciC.\n"
...
mxArray *cgxe_N6r0Omof85N1Yr8uriaciC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_N6r0Omof85N1Yr8uriaciC_fallback_info(void)
{
