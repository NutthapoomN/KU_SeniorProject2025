...
#include "m_M7SZCavjDlZZkUfGLWynC.h"
...
static void cgxe_mdl_start(InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance);
static void CheckPythonError(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key);
static void c_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void e_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void g_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void h_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void i_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void j_assignToPyDict(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *c_getPyDictVal(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance, PyObject *dict, char_T *key);
...
static void c_execPyScript(InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_M7SZCavjDlZZkUfGLWynC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_M7SZCavjDlZZkUfGLWynC(SimStruct *S, int_T tid)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_M7SZCavjDlZZkUfGLWynC(SimStruct *S)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_M7SZCavjDlZZkUfGLWynC(SimStruct *S, int_T tid)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_M7SZCavjDlZZkUfGLWynC(SimStruct *S)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_M7SZCavjDlZZkUfGLWynC(SimStruct *S)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_M7SZCavjDlZZkUfGLWynC(SimStruct *S)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_M7SZCavjDlZZkUfGLWynC(SimStruct *S)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_M7SZCavjDlZZkUfGLWynC(SimStruct *S)
{
  InstanceStruct_M7SZCavjDlZZkUfGLWynC *moduleInstance =
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC *)calloc(1, sizeof
    (InstanceStruct_M7SZCavjDlZZkUfGLWynC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_M7SZCavjDlZZkUfGLWynC);
  ssSetmdlInitializeConditions(S, mdlInitialize_M7SZCavjDlZZkUfGLWynC);
  ssSetmdlUpdate(S, mdlUpdate_M7SZCavjDlZZkUfGLWynC);
  ssSetmdlDerivatives(S, mdlDerivatives_M7SZCavjDlZZkUfGLWynC);
  ssSetmdlTerminate(S, mdlTerminate_M7SZCavjDlZZkUfGLWynC);
  ssSetmdlEnable(S, mdlEnable_M7SZCavjDlZZkUfGLWynC);
  ssSetmdlDisable(S, mdlDisable_M7SZCavjDlZZkUfGLWynC);
...
static void mdlProcessParameters_M7SZCavjDlZZkUfGLWynC(SimStruct *S)
{
}

void method_dispatcher_M7SZCavjDlZZkUfGLWynC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_M7SZCavjDlZZkUfGLWynC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_M7SZCavjDlZZkUfGLWynC(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: M7SZCavjDlZZkUfGLWynC.\n"
...
mxArray *cgxe_M7SZCavjDlZZkUfGLWynC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_M7SZCavjDlZZkUfGLWynC_fallback_info(void)
{
