...
#include "m_LiCRr0i9X7rSQC3AA7xIbG.h"
...
static void cgxe_mdl_start(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
static void CheckPythonError(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance, PyObject *dict, char_T *key);
static void b_assignToPyDict(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *b_getPyDictVal(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S, int_T tid)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S, int_T tid)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S)
{
  InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *moduleInstance =
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG *)calloc(1, sizeof
    (InstanceStruct_LiCRr0i9X7rSQC3AA7xIbG));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_LiCRr0i9X7rSQC3AA7xIbG);
  ssSetmdlInitializeConditions(S, mdlInitialize_LiCRr0i9X7rSQC3AA7xIbG);
  ssSetmdlUpdate(S, mdlUpdate_LiCRr0i9X7rSQC3AA7xIbG);
  ssSetmdlDerivatives(S, mdlDerivatives_LiCRr0i9X7rSQC3AA7xIbG);
  ssSetmdlTerminate(S, mdlTerminate_LiCRr0i9X7rSQC3AA7xIbG);
  ssSetmdlEnable(S, mdlEnable_LiCRr0i9X7rSQC3AA7xIbG);
  ssSetmdlDisable(S, mdlDisable_LiCRr0i9X7rSQC3AA7xIbG);
...
static void mdlProcessParameters_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S)
{
}

void method_dispatcher_LiCRr0i9X7rSQC3AA7xIbG(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_LiCRr0i9X7rSQC3AA7xIbG(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_LiCRr0i9X7rSQC3AA7xIbG(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: LiCRr0i9X7rSQC3AA7xIbG.\n"
...
mxArray *cgxe_LiCRr0i9X7rSQC3AA7xIbG_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_LiCRr0i9X7rSQC3AA7xIbG_fallback_info(void)
{
