...
set COMPILER=C:\ProgramData\MATLAB\SupportPackages\R2025b\3P.instrset\mingw_w64.instrset\bin\gcc
                ...
                set LINKFLAGS=-m64 -Wl,--no-undefined -shared -static -L"D:\\extern\lib\win64\mingw64" -llibmx -llibmex -llibmat -lm -llibmwlapack -llibmwblas -Wl,"D:\/extern/lib/win64/mingw64/mexFunction.def"
                set LINKDEBUGFLAGS=-g
                set NAME_OUTPUT=-o "%OUTDIR%%MEX_NAME%%MEX_EXT%"
set PATH=C:\ProgramData\MATLAB\SupportPackages\R2025b\3P.instrset\mingw_w64.instrset\bin;D:\\extern\include\win64;D:\\extern\include;D:\\simulink\include;D:\\lib\win64;%MATLAB_BIN%;%PATH%
...
set LIBPATH=D:\\extern\lib\win64;%LIBPATH%

gmake SHELL="cmd" -f Model_AC_TES_Double_Coil_Modify_cgxe.gmk
