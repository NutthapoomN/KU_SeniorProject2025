...
#include "m_Fj20vbVHhdz11UNm0Vb2UE.h"
...
static void cgxe_mdl_start(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
static void CheckPythonError(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance, PyObject *dict, char_T *key);
static void b_assignToPyDict(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *b_getPyDictVal(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static int32_T b_deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S, int_T tid)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S, int_T tid)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S)
{
  InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *moduleInstance =
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE *)calloc(1, sizeof
    (InstanceStruct_Fj20vbVHhdz11UNm0Vb2UE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Fj20vbVHhdz11UNm0Vb2UE);
  ssSetmdlInitializeConditions(S, mdlInitialize_Fj20vbVHhdz11UNm0Vb2UE);
  ssSetmdlUpdate(S, mdlUpdate_Fj20vbVHhdz11UNm0Vb2UE);
  ssSetmdlDerivatives(S, mdlDerivatives_Fj20vbVHhdz11UNm0Vb2UE);
  ssSetmdlTerminate(S, mdlTerminate_Fj20vbVHhdz11UNm0Vb2UE);
  ssSetmdlEnable(S, mdlEnable_Fj20vbVHhdz11UNm0Vb2UE);
  ssSetmdlDisable(S, mdlDisable_Fj20vbVHhdz11UNm0Vb2UE);
...
static void mdlProcessParameters_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S)
{
}

void method_dispatcher_Fj20vbVHhdz11UNm0Vb2UE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Fj20vbVHhdz11UNm0Vb2UE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Fj20vbVHhdz11UNm0Vb2UE(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Fj20vbVHhdz11UNm0Vb2UE.\n"
...
mxArray *cgxe_Fj20vbVHhdz11UNm0Vb2UE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Fj20vbVHhdz11UNm0Vb2UE_fallback_info(void)
{
