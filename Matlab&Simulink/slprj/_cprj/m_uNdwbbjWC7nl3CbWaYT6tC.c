...
#include "m_uNdwbbjWC7nl3CbWaYT6tC.h"
...
static void cgxe_mdl_start(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
static void CheckPythonError(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void e_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *c_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *e_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *f_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static void g_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void h_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void i_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void j_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void k_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void l_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void m_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void n_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void o_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void p_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void q_assignToPyDict(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *g_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *h_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *i_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *j_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *k_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *l_getPyDictVal(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance, PyObject *dict, char_T *key);
...
static void c_execPyScript(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC
  *moduleInstance);
  ...
  *moduleInstance)
{
  ...
  assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Comp", 0.0);
  b_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Cond", 0.0);
  c_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Fan", 0.0);
  d_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Pump", 0.0);
  e_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "V2", 0.0);
  f_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "V3", 0.0);
  execPyScript(moduleInstance, "", moduleInstance->namespaceDict);
  r = getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Comp");
  *moduleInstance->b_y0 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = b_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Cond");
  *moduleInstance->y5 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = c_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Fan");
  *moduleInstance->b_y1 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = d_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Pump");
  *moduleInstance->y2 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = e_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "V2");
  *moduleInstance->y4 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = f_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "V3");
  ...
  *moduleInstance)
{
  PyObject *r;
  moduleInstance->GIL = PyGILState_Ensure();
  g_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Comp",
                   *moduleInstance->b_y0);
  h_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Cond",
                   *moduleInstance->y5);
  i_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Fan",
                   *moduleInstance->b_y1);
  j_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "Pump",
                   *moduleInstance->y2);
  k_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "V2",
                   *moduleInstance->y4);
  l_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "V3",
                   *moduleInstance->y3);
  m_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "day",
                   *moduleInstance->u0);
  n_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "hour",
                   *moduleInstance->u1);
  o_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "people",
                   *moduleInstance->u2);
  p_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "t_room",
                   *moduleInstance->u3);
  q_assignToPyDict(moduleInstance, moduleInstance->namespaceDict, "t_tes",
                   *moduleInstance->u4);
  b_execPyScript(moduleInstance,
                 ...
                 "  fan  = round(fuzzy_sim.output[\'fan_speed\'] / 100, 2)\n\n    return cond, v2, v3, pump, fan, comp\n\nCond,V2,V3,Pump,Fan,Comp"
                 " = tes_controller(1, 14, 12, 28, 7)\n",
                 moduleInstance->namespaceDict);
  r = g_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Comp");
  *moduleInstance->b_y0 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = h_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Cond");
  *moduleInstance->y5 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = i_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Fan");
  *moduleInstance->b_y1 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = j_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "Pump");
  *moduleInstance->y2 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = k_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "V2");
  *moduleInstance->y4 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  r = l_getPyDictVal(moduleInstance, moduleInstance->namespaceDict, "V3");
  *moduleInstance->y3 = PyObj_marshalIn(moduleInstance, r, NULL);
  Py_DecRef(r);
  PyGILState_Release(moduleInstance->GIL);
}
...
/* CGXE Glue Code */
static void mdlOutputs_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S, int_T tid)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S, int_T tid)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S)
{
  InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *moduleInstance =
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC *)calloc(1, sizeof
    (InstanceStruct_uNdwbbjWC7nl3CbWaYT6tC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_uNdwbbjWC7nl3CbWaYT6tC);
  ssSetmdlInitializeConditions(S, mdlInitialize_uNdwbbjWC7nl3CbWaYT6tC);
  ssSetmdlUpdate(S, mdlUpdate_uNdwbbjWC7nl3CbWaYT6tC);
  ssSetmdlDerivatives(S, mdlDerivatives_uNdwbbjWC7nl3CbWaYT6tC);
  ssSetmdlTerminate(S, mdlTerminate_uNdwbbjWC7nl3CbWaYT6tC);
  ssSetmdlEnable(S, mdlEnable_uNdwbbjWC7nl3CbWaYT6tC);
  ssSetmdlDisable(S, mdlDisable_uNdwbbjWC7nl3CbWaYT6tC);
...
static void mdlProcessParameters_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S)
{
}

void method_dispatcher_uNdwbbjWC7nl3CbWaYT6tC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_uNdwbbjWC7nl3CbWaYT6tC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_uNdwbbjWC7nl3CbWaYT6tC(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: uNdwbbjWC7nl3CbWaYT6tC.\n"
...
mxArray *cgxe_uNdwbbjWC7nl3CbWaYT6tC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_uNdwbbjWC7nl3CbWaYT6tC_fallback_info(void)
{
