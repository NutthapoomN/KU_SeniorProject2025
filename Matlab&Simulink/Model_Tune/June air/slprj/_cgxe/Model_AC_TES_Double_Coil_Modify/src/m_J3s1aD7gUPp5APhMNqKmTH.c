...
static void cgxe_mdl_start(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
static void CheckPythonError(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance, PyObject *dict, char_T *key);
static void b_assignToPyDict(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *b_getPyDictVal(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_J3s1aD7gUPp5APhMNqKmTH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S, int_T tid)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S, int_T tid)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S)
{
  InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *moduleInstance =
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH *)calloc(1, sizeof
    (InstanceStruct_J3s1aD7gUPp5APhMNqKmTH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_J3s1aD7gUPp5APhMNqKmTH);
  ssSetmdlInitializeConditions(S, mdlInitialize_J3s1aD7gUPp5APhMNqKmTH);
  ssSetmdlUpdate(S, mdlUpdate_J3s1aD7gUPp5APhMNqKmTH);
  ssSetmdlDerivatives(S, mdlDerivatives_J3s1aD7gUPp5APhMNqKmTH);
  ssSetmdlTerminate(S, mdlTerminate_J3s1aD7gUPp5APhMNqKmTH);
  ssSetmdlEnable(S, mdlEnable_J3s1aD7gUPp5APhMNqKmTH);
  ssSetmdlDisable(S, mdlDisable_J3s1aD7gUPp5APhMNqKmTH);
...
static void mdlProcessParameters_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S)
{
}

void method_dispatcher_J3s1aD7gUPp5APhMNqKmTH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_J3s1aD7gUPp5APhMNqKmTH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_J3s1aD7gUPp5APhMNqKmTH(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: J3s1aD7gUPp5APhMNqKmTH.\n"
...
mxArray *cgxe_J3s1aD7gUPp5APhMNqKmTH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_J3s1aD7gUPp5APhMNqKmTH_fallback_info(void)
{
