...
#include "m_dmlBvAV1dLNVehT0fGjccF.h"
...
static void cgxe_mdl_start(InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
static void CheckPythonError(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key);
static void c_assignToPyDict(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void e_assignToPyDict(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *c_getPyDictVal(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static int32_T b_deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_dmlBvAV1dLNVehT0fGjccF
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_dmlBvAV1dLNVehT0fGjccF(SimStruct *S, int_T tid)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_dmlBvAV1dLNVehT0fGjccF(SimStruct *S)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_dmlBvAV1dLNVehT0fGjccF(SimStruct *S, int_T tid)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_dmlBvAV1dLNVehT0fGjccF(SimStruct *S)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_dmlBvAV1dLNVehT0fGjccF(SimStruct *S)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_dmlBvAV1dLNVehT0fGjccF(SimStruct *S)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_dmlBvAV1dLNVehT0fGjccF(SimStruct *S)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_dmlBvAV1dLNVehT0fGjccF(SimStruct *S)
{
  InstanceStruct_dmlBvAV1dLNVehT0fGjccF *moduleInstance =
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF *)calloc(1, sizeof
    (InstanceStruct_dmlBvAV1dLNVehT0fGjccF));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_dmlBvAV1dLNVehT0fGjccF);
  ssSetmdlInitializeConditions(S, mdlInitialize_dmlBvAV1dLNVehT0fGjccF);
  ssSetmdlUpdate(S, mdlUpdate_dmlBvAV1dLNVehT0fGjccF);
  ssSetmdlDerivatives(S, mdlDerivatives_dmlBvAV1dLNVehT0fGjccF);
  ssSetmdlTerminate(S, mdlTerminate_dmlBvAV1dLNVehT0fGjccF);
  ssSetmdlEnable(S, mdlEnable_dmlBvAV1dLNVehT0fGjccF);
  ssSetmdlDisable(S, mdlDisable_dmlBvAV1dLNVehT0fGjccF);
...
static void mdlProcessParameters_dmlBvAV1dLNVehT0fGjccF(SimStruct *S)
{
}

void method_dispatcher_dmlBvAV1dLNVehT0fGjccF(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_dmlBvAV1dLNVehT0fGjccF(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_dmlBvAV1dLNVehT0fGjccF(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: dmlBvAV1dLNVehT0fGjccF.\n"
...
mxArray *cgxe_dmlBvAV1dLNVehT0fGjccF_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_dmlBvAV1dLNVehT0fGjccF_fallback_info(void)
{
