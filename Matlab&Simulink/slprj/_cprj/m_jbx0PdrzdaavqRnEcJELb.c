...
#include "m_jbx0PdrzdaavqRnEcJELb.h"
...
static void cgxe_mdl_start(InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance);
static void CheckPythonError(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key);
static void c_assignToPyDict(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void e_assignToPyDict(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *c_getPyDictVal(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static int32_T b_deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_jbx0PdrzdaavqRnEcJELb
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_jbx0PdrzdaavqRnEcJELb(SimStruct *S, int_T tid)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_jbx0PdrzdaavqRnEcJELb(SimStruct *S)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_jbx0PdrzdaavqRnEcJELb(SimStruct *S, int_T tid)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_jbx0PdrzdaavqRnEcJELb(SimStruct *S)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_jbx0PdrzdaavqRnEcJELb(SimStruct *S)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_jbx0PdrzdaavqRnEcJELb(SimStruct *S)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_jbx0PdrzdaavqRnEcJELb(SimStruct *S)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_jbx0PdrzdaavqRnEcJELb(SimStruct *S)
{
  InstanceStruct_jbx0PdrzdaavqRnEcJELb *moduleInstance =
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb *)calloc(1, sizeof
    (InstanceStruct_jbx0PdrzdaavqRnEcJELb));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_jbx0PdrzdaavqRnEcJELb);
  ssSetmdlInitializeConditions(S, mdlInitialize_jbx0PdrzdaavqRnEcJELb);
  ssSetmdlUpdate(S, mdlUpdate_jbx0PdrzdaavqRnEcJELb);
  ssSetmdlDerivatives(S, mdlDerivatives_jbx0PdrzdaavqRnEcJELb);
  ssSetmdlTerminate(S, mdlTerminate_jbx0PdrzdaavqRnEcJELb);
  ssSetmdlEnable(S, mdlEnable_jbx0PdrzdaavqRnEcJELb);
  ssSetmdlDisable(S, mdlDisable_jbx0PdrzdaavqRnEcJELb);
...
static void mdlProcessParameters_jbx0PdrzdaavqRnEcJELb(SimStruct *S)
{
}

void method_dispatcher_jbx0PdrzdaavqRnEcJELb(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_jbx0PdrzdaavqRnEcJELb(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_jbx0PdrzdaavqRnEcJELb(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: jbx0PdrzdaavqRnEcJELb.\n"
...
mxArray *cgxe_jbx0PdrzdaavqRnEcJELb_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_jbx0PdrzdaavqRnEcJELb_fallback_info(void)
{
