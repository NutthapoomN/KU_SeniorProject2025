...
#include "m_Fy1mPMYU2fheSweB1fg0Y.h"
...
static void cgxe_mdl_start(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance);
static void CheckPythonError(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance, PyObject *dict, char_T *key);
static void b_assignToPyDict(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *b_getPyDictVal(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_Fy1mPMYU2fheSweB1fg0Y
  *moduleInstance);
...
{
  moduleInstance->GIL = PyGILState_Ensure();
  deleteDictItem(moduleInstance->namespaceDict, "input");
...
/* CGXE Glue Code */
static void mdlOutputs_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S, int_T tid)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S, int_T tid)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S)
{
  InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *moduleInstance =
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y *)calloc(1, sizeof
    (InstanceStruct_Fy1mPMYU2fheSweB1fg0Y));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_Fy1mPMYU2fheSweB1fg0Y);
  ssSetmdlInitializeConditions(S, mdlInitialize_Fy1mPMYU2fheSweB1fg0Y);
  ssSetmdlUpdate(S, mdlUpdate_Fy1mPMYU2fheSweB1fg0Y);
  ssSetmdlDerivatives(S, mdlDerivatives_Fy1mPMYU2fheSweB1fg0Y);
  ssSetmdlTerminate(S, mdlTerminate_Fy1mPMYU2fheSweB1fg0Y);
  ssSetmdlEnable(S, mdlEnable_Fy1mPMYU2fheSweB1fg0Y);
  ssSetmdlDisable(S, mdlDisable_Fy1mPMYU2fheSweB1fg0Y);
...
static void mdlProcessParameters_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S)
{
}

void method_dispatcher_Fy1mPMYU2fheSweB1fg0Y(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_Fy1mPMYU2fheSweB1fg0Y(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_Fy1mPMYU2fheSweB1fg0Y(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: Fy1mPMYU2fheSweB1fg0Y.\n"
...
mxArray *cgxe_Fy1mPMYU2fheSweB1fg0Y_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_Fy1mPMYU2fheSweB1fg0Y_fallback_info(void)
{
