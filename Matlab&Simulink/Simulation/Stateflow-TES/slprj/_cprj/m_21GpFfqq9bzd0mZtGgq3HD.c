...
static void cgxe_mdl_start(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
static void CheckPythonError(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance, PyObject *dict, char_T *key);
static void b_assignToPyDict(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *b_getPyDictVal(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance, PyObject *dict, char_T *key);
static int32_T deleteDictItem(PyObject *dict, char_T *key);
static int32_T b_deleteDictItem(PyObject *dict, char_T *key);
static void c_execPyScript(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_21GpFfqq9bzd0mZtGgq3HD
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S, int_T tid)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S, int_T tid)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S)
{
  InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *moduleInstance =
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD *)calloc(1, sizeof
    (InstanceStruct_21GpFfqq9bzd0mZtGgq3HD));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_21GpFfqq9bzd0mZtGgq3HD);
  ssSetmdlInitializeConditions(S, mdlInitialize_21GpFfqq9bzd0mZtGgq3HD);
  ssSetmdlUpdate(S, mdlUpdate_21GpFfqq9bzd0mZtGgq3HD);
  ssSetmdlDerivatives(S, mdlDerivatives_21GpFfqq9bzd0mZtGgq3HD);
  ssSetmdlTerminate(S, mdlTerminate_21GpFfqq9bzd0mZtGgq3HD);
  ssSetmdlEnable(S, mdlEnable_21GpFfqq9bzd0mZtGgq3HD);
  ssSetmdlDisable(S, mdlDisable_21GpFfqq9bzd0mZtGgq3HD);
...
static void mdlProcessParameters_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S)
{
}

void method_dispatcher_21GpFfqq9bzd0mZtGgq3HD(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_21GpFfqq9bzd0mZtGgq3HD(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_21GpFfqq9bzd0mZtGgq3HD(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 21GpFfqq9bzd0mZtGgq3HD.\n"
...
mxArray *cgxe_21GpFfqq9bzd0mZtGgq3HD_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_21GpFfqq9bzd0mZtGgq3HD_fallback_info(void)
{
