...
#include "m_NiRpZBW33fLJOwLBWZDch.h"
...
static void cgxe_mdl_start(InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance);
static void cgxe_mdl_derivative(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance);
static void CheckPythonError(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *pyObjsToRelease[], int32_T numObjToRelease);
static real_T PyObj_marshalIn(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *pyToMarshal, PyObject *pyOwner);
static PyObject *getPyNamespaceDict(void);
static void assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance,
  PyObject *dict, char_T *key, real_T val);
static void b_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void c_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void d_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void e_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void f_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void execPyScript(InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *b_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *c_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *d_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *e_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *f_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static void g_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void h_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void i_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void j_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void k_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void l_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void m_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void n_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void o_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void p_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void q_assignToPyDict(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key, real_T val);
static void b_execPyScript(InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance,
  char_T *script, PyObject *ns);
static PyObject *g_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *h_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *i_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *j_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *k_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
static PyObject *l_getPyDictVal(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance, PyObject *dict, char_T *key);
...
static void c_execPyScript(InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance,
  char_T *script, PyObject *ns);
static void init_simulink_io_address(InstanceStruct_NiRpZBW33fLJOwLBWZDch
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_NiRpZBW33fLJOwLBWZDch(SimStruct *S, int_T tid)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_NiRpZBW33fLJOwLBWZDch(SimStruct *S)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_NiRpZBW33fLJOwLBWZDch(SimStruct *S, int_T tid)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)cgxertGetRuntimeInstance(S);
...
static void mdlDerivatives_NiRpZBW33fLJOwLBWZDch(SimStruct *S)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_NiRpZBW33fLJOwLBWZDch(SimStruct *S)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_NiRpZBW33fLJOwLBWZDch(SimStruct *S)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_NiRpZBW33fLJOwLBWZDch(SimStruct *S)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_NiRpZBW33fLJOwLBWZDch(SimStruct *S)
{
  InstanceStruct_NiRpZBW33fLJOwLBWZDch *moduleInstance =
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch *)calloc(1, sizeof
    (InstanceStruct_NiRpZBW33fLJOwLBWZDch));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_NiRpZBW33fLJOwLBWZDch);
  ssSetmdlInitializeConditions(S, mdlInitialize_NiRpZBW33fLJOwLBWZDch);
  ssSetmdlUpdate(S, mdlUpdate_NiRpZBW33fLJOwLBWZDch);
  ssSetmdlDerivatives(S, mdlDerivatives_NiRpZBW33fLJOwLBWZDch);
  ssSetmdlTerminate(S, mdlTerminate_NiRpZBW33fLJOwLBWZDch);
  ssSetmdlEnable(S, mdlEnable_NiRpZBW33fLJOwLBWZDch);
  ssSetmdlDisable(S, mdlDisable_NiRpZBW33fLJOwLBWZDch);
...
static void mdlProcessParameters_NiRpZBW33fLJOwLBWZDch(SimStruct *S)
{
}

void method_dispatcher_NiRpZBW33fLJOwLBWZDch(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_NiRpZBW33fLJOwLBWZDch(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_NiRpZBW33fLJOwLBWZDch(S);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: NiRpZBW33fLJOwLBWZDch.\n"
...
mxArray *cgxe_NiRpZBW33fLJOwLBWZDch_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_NiRpZBW33fLJOwLBWZDch_fallback_info(void)
{
